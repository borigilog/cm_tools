...
namespace TestConfiguration
{
    ...
    public class TestDomain
    {
        ...
        protected string dir = Path.GetFullPath(@"..\..\..\CmTool.Domain.Test\TestData\XML\");
        ...
        {
            var tr = new FeatureSettingsFileReader(new SettingsToolConfiguration { XmlSettingsDirectory = dir });
